const CACHE = 'aussteiger-bandapp-v5-1';
const APP_SHELL = ['./','./index.html','./chords.html','./app.js','./styles.css','./manifest.json','./songs.json','./setlists.json','./assets/icons/icon.svg','./assets/icons/icon-180.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
